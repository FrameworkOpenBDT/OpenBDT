...
public class DataBind {
	 ...
	 * 
	 */
	public void generateReport() throws ReportException, IOException, PropertyNotFoundException, PropertyException {
		...
		try {
			...
			// File output
			file = new FileWriter(new File(PropertiesSerenityUtil.getProperty("openbdt.report.outputDirectory")));
